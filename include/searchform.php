...
// $Id: searchform.php,v 1.2 2006/03/27 08:20:23 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
$type_select->addOptionArray(['AND' => _MD_ALL, 'OR' => _MD_ANY, 'exact' => _MD_EXACT]);
...
if (empty($modules)) {
    ...
    $mod_arr = $moduleHandler->getList($criteria);
...
if (1 == $xoopsModuleConfig['search_display_text']) {
